...
def get_data(dataset='mnist',d=0):
    '''
...
def get_args():
    ...
    parser.add_argument('--optimizer_name', choices = ['sgd', 'rmsprop', 'adadelta', 'adagrad', 'adam', 'asgd'], default = 'adam',
        help = 'optimizer')
    parser.add_argument('--method', choices = ['nonlinear_IB', 'variational_IB','drop_VIB','intel_VIB'], default = 'nonlinear_IB',

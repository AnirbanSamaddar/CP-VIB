...
if args.method == 'variational_IB': 
    args.logs_dir += args.u_func_name + '_' + str(round(args.hyperparameter,2)).replace('.', '-')  + "_repl_" + str(args.repl_n) + "_a_"+ str(args.a)+"_b_"+str(args.b) + "_compound" + '/'
    args.figs_dir += args.u_func_name + '_' + str(round(args.hyperparameter,2)).replace('.', '-') + "_repl_" + str(args.repl_n) + "_a_"+ str(args.a)+"_b_"+str(args.b) + "_compound" + '/'
    args.models_dir += args.u_func_name + '_' + str(round(args.hyperparameter,2)).replace('.', '-') + "_repl_" + str(args.repl_n) + "_a_"+ str(args.a)+"_b_"+str(args.b) + "_compound" + '/'
else:
    args.logs_dir += args.u_func_name + '_' + str(round(args.hyperparameter,2)).replace('.', '-')  + "_repl_" + str(args.repl_n) + "_a_"+ str(args.a)+"_b_"+str(args.b) + "_" + args.method + '/'
    args.figs_dir += args.u_func_name + '_' + str(round(args.hyperparameter,2)).replace('.', '-') + "_repl_" + str(args.repl_n) + "_a_"+ str(args.a)+"_b_"+str(args.b) + "_" + args.method + '/'
    args.models_dir += args.u_func_name + '_' + str(round(args.hyperparameter,2)).replace('.', '-') + "_repl_" + str(args.repl_n) + "_a_"+ str(args.a)+"_b_"+str(args.b) + "_" + args.method + '/'
...
# Save the network
name_base = "K-" + str(args.K) + "-B-" + str(round((args.beta-1)/49,3)).replace('.', '-') \
